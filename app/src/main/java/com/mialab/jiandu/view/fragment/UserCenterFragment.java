...
public class UserCenterFragment extends BaseFragment implements UserCenterView, View.OnClickListener {
    ...
    protected void initView() {
        if (userCenterPresenter == null) {
            userCenterPresenter = new UserCenterPresenter(context, this);
        }
        if (hasLogin()) {
            user = userCenterPresenter.getUserInfoFormCache(PrefUtils.getString(context, GlobalConf.PHONE, ""));
    ...
    private boolean hasLogin() {
        String accessToken = PrefUtils.getString(context, GlobalConf.ACCESS_TOKEN, "");
